    ...
    <>
      ...
      <div className="page-hero about-page-hero">
        <div className="page-hero__photo" aria-hidden="true">
          <img
            src="https://res.cloudinary.com/dgde8cwjk/image/upload/f_auto,q_auto,w_1600/v1789144768/oluyole-08-exam-room-empty_ikvfb5.jpg"
            alt=""
          />
        </div>
      ...
      <div className="container about-mission__grid">
        <div className="reveal reveal--left" ref={leftRef}>
          ...
          <p className="section-subtitle" style={{ marginBottom: "1rem" }}>
            ...
            branches at Royal Mall Bodija and Oluyole Estate making quality eye
            care accessible wherever you are in the city.
          </p>
