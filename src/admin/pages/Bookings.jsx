...
function WalkInModal({ onClose, onSaved }) {
  ...
  async function handleSave() {
    ...
    const payload = {
      ...
      organization_name:
        form.booking_type === "group" ? form.organization_name || null : null,
      status: "upcoming",
    };
  ...
  return (
    <div className="admin-modal-backdrop" onClick={onClose}>
      <div
        className="admin-modal walkin-modal"
        ...
        <div className="walkin-modal-header">
          <div>
            ...
            <p className="walkin-note">
              Slot capacity limits are bypassed — front desk has full
              discretion.
            </p>
          </div>
        ...
        <div className="walkin-form">
          ...
          <div className="walkin-row">
            <div className="walkin-field">
              ...
              <input
                className={`walkin-input${errors.name ? " walkin-input--err" : ""}`}
                value={form.name}
            ...
            <div className="walkin-field">
              ...
              <input
                className={`walkin-input${errors.phone ? " walkin-input--err" : ""}`}
                value={form.phone}
                onChange={(e) => set("phone", e.target.value)}
                placeholder="08012345678"
              />
              {errors.phone && (
                <span className="walkin-err">{errors.phone}</span>
              )}
            </div>
          </div>
          ...
          <div className="walkin-row">
            <div className="walkin-field">
              ...
              <select
                className={`walkin-input walkin-select${errors.service ? " walkin-input--err" : ""}`}
                value={form.service}
              ...
              {errors.service && (
                <span className="walkin-err">{errors.service}</span>
              )}
            </div>
            <div className="walkin-field">
              <label className="walkin-label">Branch *</label>
              <select
                className={`walkin-input walkin-select${errors.location ? " walkin-input--err" : ""}`}
                value={form.location}
              ...
              {errors.location && (
                <span className="walkin-err">{errors.location}</span>
              )}
            </div>
          </div>
          ...
          <div className="walkin-row">
            <div className="walkin-field">
              ...
              <input
                type="date"
                className={`walkin-input${errors.date ? " walkin-input--err" : ""}`}
                value={form.date}
            ...
            <div className="walkin-field">
              ...
              <select
                className={`walkin-input walkin-select${errors.time_slot ? " walkin-input--err" : ""}`}
              ...
              {errors.time_slot && (
                <span className="walkin-err">{errors.time_slot}</span>
              )}
            </div>
          </div>
          ...
          {form.booking_type === "group" && (
            <div className="walkin-row">
              <div className="walkin-field">
                ...
                />
                {errors.group_size && (
                  <span className="walkin-err">{errors.group_size}</span>
                )}
              </div>
              <div className="walkin-field">
                ...
                return (
                  <tr key={b.id}>
                    ...
                    <td>
                      ...
                      <EditorStamp
                        updatedBy={b.status_updated_by}
                        updatedAt={b.status_updated_at}
        ...
        <div className="bk-pagination">
          ...
          <div className="bk-pagination-controls">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1)
              ...
              .map((p, i) =>
                p === "…" ? (
                  <span key={`ellipsis-${i}`} className="bk-page-ellipsis">
                    …
                  </span>
                ) : (
                  <button
